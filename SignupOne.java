...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne()
    {
        ...
        random=Math.abs(ran.nextLong()%9000L)+1000L;JLabel formno=new JLabel("APPLICATION FORM NO. "+ random);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String dob=((JTextField)dateChooser.getDateEditor().getUiComponent()).getText();String gender=null;
        if(male.isSelected())
        {
            gender="Male";
        }
